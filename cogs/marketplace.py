    ...
    class ShopView(discord.ui.View):
        ...
        @discord.ui.select(
          ...
          options = [
            ...
            discord.SelectOption(emoji='🤵', label="Waistcoat", description = "Value: 🪙 90"),
            ...
            discord.SelectOption(emoji='💼', label="Leather Briefcase", description = "Value: 🪙 80"),
            ...
            discord.SelectOption(emoji='🗡️', label="Silver Pocket Knife", description = "Value: 🪙 50"),
