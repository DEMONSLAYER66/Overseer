...
###################################EMBEDDER################################
    ...
    class EmbedderModal(discord.ui.Modal):
        def __init__(self, *args, **kwargs):
            ...
            self.add_item(discord.ui.InputText(label="Embed Title", placeholder="Enter embed title.", style=discord.InputTextStyle.long, required=False, max_length=256))
            ...
            self.add_item(discord.ui.InputText(label="Field Title", placeholder="Enter field title.", style=discord.InputTextStyle.long, required=False, max_length=256))
