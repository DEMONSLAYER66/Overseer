...
############################ PROMOTE #########################
    ...
    async def send_reminder(self, cooldown):
        ...
        #except the bot was unable to do something from the above
        except:
            pass
...
###################################EMBEDDER################################
    ...
    class EmbedderModal(discord.ui.Modal):
        def __init__(self, *args, **kwargs):
            ...
            self.add_item(discord.ui.InputText(label="Field Text", style=discord.InputTextStyle.long, placeholder="Enter text that will appear in the field of the embed.", required=False))
            self.add_item(discord.ui.InputText(label="Footer Text", style=discord.InputTextStyle.long, placeholder="Enter text that will appear in the footer of the embed.", required=False))
